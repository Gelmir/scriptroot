#define MyAppName "Qt Creator (x64 Edition)"
#define MyAppPublisher ""
#define MyAppCopyright "© 2008-2015 The Qt Company Ltd. Все права защищены."
#define MyAppURL "https://www.qt.io/"
...
AppId={{78026F0B-8926-4E1D-9EE2-AB74E6653246}
AppName={#MyAppName}
...
begin  
  ...
  if Exec(ExpandConstant('{tmp}\processviewer.exe'), 'qtcreator.exe', '', SW_HIDE, ewWaitUntilTerminated, ExitCode)
  then
  begin
    // Process found
    Result := ( ExitCode > 0 );
...
begin
  ...
  then
  begin
    MsgBox( 'qtcreator is already running. Please close all application instances and restart setup.', mbInformation, MB_OK );
    Result := False;
  end
  else
  begin

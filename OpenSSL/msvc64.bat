...
"C:\Program Files\7-Zip\7z.exe" x %ARCHIVES%\OpenSSL-1.0.2f.7z -o%SOURCEROOT%\OpenSSL
SET "CFLAGS=/O2 /favor:blend /GL /Y- /MD /w /nologo"
...
FOR /f "delims=" %%A IN ('findstr "^CFLAG\=" .\ms\ntdll.mak ^| sed -e "s:^CFLAG=::" -e "s:[\/-]O[012xstd] ::g" -e "s:[\/-]favor\:[-A-Z0-9]* ::g" -e "s:[\/-]GL ::g" -e "s:[\/-]Y ::g" -e "s:[\/-]MP ::g" -e "s:[\/-]M[DT][dt]\? ::g" -e "s:[\/-][Ww][0-9al]* ::g" -e "s:[\/-]G[SsYy]0\? ::g" -e "s:[\/-]nologo ::g"') DO @SET FLAGS1=%%A
